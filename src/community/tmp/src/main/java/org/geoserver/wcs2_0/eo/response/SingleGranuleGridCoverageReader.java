...
public class SingleGranuleGridCoverageReader implements StructuredGridCoverage2DReader {
    ...
    public String getMetadataValue(String name) throws IOException {
        if(GridCoverage2DReader.TIME_DOMAIN.equals(name) || GridCoverage2DReader.TIME_DOMAIN_MAXIMUM.equals(name) || GridCoverage2DReader.TIME_DOMAIN_MINIMUM.equals(name)) {
            return featureTime;
        }
